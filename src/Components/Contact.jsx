			...
			<div className="container">
				...
				<div className="row pb-1">
					...
					<div className="col-sm-4 text-center contact-item mb-4">
						...
						<a className="icon" href="#link"><i className="fa fa-phone fa-fw"></i></a>
						<h2>Call us</h2>
						<p>+01 234-56789</p>
					...
					<form ref={form} onSubmit={sendEmail} id="contact-form" className="col-sm-6 col-sm-offset-3 mx-auto pb-4">
						...
						<div className="form-group">
						  ...
						  <div className="controls">
							...
							{errors.username && <span className='mail_errors'>{errors.username}</span>}
						...
						<div className="form-group">
						  ...
						  <div className=" controls">
							...
							{errors.email && <span className='mail_errors'>{errors.email}</span>}
						  </div>
						</div>
						...
						<div className="form-group">
						  <label className="control-label" htmlFor="contact-message">Message</label>
							<div className="controls">
								...
								{errors.message && <span className='mail_errors'>{errors.message}</span>}
							</div>
